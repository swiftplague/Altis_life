class perm_dlg_new
{
	...
	class controlsBackground 
	{
		...
		{
			idc = 1100;
			text = "<t size='1.2' align='center'>Group management</t>"; //--- ToDo: Localize;
		...
		{
			idc = 1001;
			text = "Rank 0 (Default)"; //--- ToDo: Localize;
			x = 1.5 * GUI_GRID_W + GUI_GRID_X;
	...
	class controls 
	{
		class bAdmin: RscButtonMenu
		{
			...
			w = 4 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
			onButtonClick = "if((call life_adminlevel) > 0) then { life_permmanager_admin = true; [] spawn life_fnc_permManager_update; hint ""Admin mode enabled."";};";
		};
		...
		class bSetRank: RscButtonMenu
		{
			...
			w = 4 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
			tooltip = "Set rank (0 corresponds to throw out))"; //--- ToDo: Localize;
			onButtonClick="[] spawn life_fnc_permManager_set;";
		};
		class bSetLevel0: RscButtonMenu
		{
			idc = 2403;
			text = "Throw out"; //--- ToDo: Localize;
			x = 31 * GUI_GRID_W + GUI_GRID_X;
			y = 21 * GUI_GRID_H + GUI_GRID_Y;
			w = 7 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
			tooltip = "Players throw out"; //--- ToDo: Localize;
