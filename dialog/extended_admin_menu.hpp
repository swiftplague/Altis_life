...
class life_extended_admin_menu {
	...
	class controlsBackground 
	{
		...
		{
			idc = -1;
			text = "Advanced admintools"; //--- ToDo: Localize;
			x = 2 * GUI_GRID_W + GUI_GRID_X;
			y = 1 * GUI_GRID_H + GUI_GRID_Y;
			w = 37 * GUI_GRID_W;
			h = 1 * GUI_GRID_H; 
	...
	class controls 
	{
		...
		class player_b_tpHere: Life_RscButtonMenu
		{
			...
			w = 4 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
			tooltip = "Teleport player to me"; //--- ToDo: Localize;
		...
		class player_b_tpTo: Life_RscButtonMenu
		{
			...
			w = 4 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
			tooltip = "Teleport to the player"; //--- ToDo: Localize;
		...
		{
			idc = -1;
			text = "Marktprice Reset"; //--- ToDo: Localize;
			x = 2.5 * GUI_GRID_W + GUI_GRID_X;
