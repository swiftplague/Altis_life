...
{
	hint format ["Home found: %1", _x select 0];
...
switch (_side) do
{
	...
	case west:
	{
		_spawns = _spawns + [
			...
			["cop_spawn_2","Air Outpost","\a3\ui_f\data\map\MapControl\fuelstation_ca.paa"],
	...
	case civilian:
	{
		...
		{
			_spawns = _spawns + [
			["civ_adac_spawn","ADAC-Headquarters","icons\wrench.paa"]
			];
		};
		...
		_spawns = _spawns + [
			...
			["civ_spawn_2","NML Pyrgos","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
			["civ_spawn_3","Athira","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
			["civ_spawn_4","NMLSofia","\a3\ui_f\data\map\MapControl\watertower_ca.paa"]
		];
	};
...
_spawns = _spawns + [ ["all_schiessplatz", "Firing range", "icons\schiessplatz.paa" ] ];
