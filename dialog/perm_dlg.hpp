class perm_dlg
{
	...
	class controlsBackground 
	{
		...
		{
			idc = 1100;
			text = "<t align='center' size='1.2'>Group management</t>"; //--- ToDo: Localize;
	...
	class controls 
	{
		class bAdminGroupMgr: RscButtonMenu
		{
			...
			w = 6 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
			tooltip = "Start Group management with admin rights"; //--- ToDo: Localize;
			onButtonClick = "if((call life_adminlevel) > 0) then { life_permmanager_admin = true; [] call life_fnc_permManager_update; hint ""Admin mode Enabled."";};";
		};
