...
life_cur_task setSimpleTaskDescription [format["You should bring this package to %1.",toUpper _dp],"Delivery Job",""];
life_cur_task setTaskState "Assigned";
player setCurrentTask life_cur_task;

["DeliveryAssigned",[format["Take the package to %1",toUpper _dp]]] call bis_fnc_showNotification;
...
[] spawn
{
	...
	if(!alive player) then
	{
		...
		["DeliveryFailed",["You could not deliver the packet."]] call BIS_fnc_showNotification;
