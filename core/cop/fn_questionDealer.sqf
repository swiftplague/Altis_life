...
if(count _sellers == 0) exitWith {hint "Nobody has sold something this dealer lately."}; //No data.
...
hint parseText format["following people the dealers have sold something recently:<br/><br/>%1",_names];
