...
if(!isPlayer _curTarget) exitWith {hint "Target is not a player"; closeDialog 0; };
...
/*else
{
	hint "Hinweis: Du kannst die Person nicht ins Gefängnis stecken";



	sleep 2;
	hint "Du musst in der Nähe einer Polizeistation sein.";
};*/
