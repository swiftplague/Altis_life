...
if(_value > 0) then
{
	[[0,format["A vehicle was searched and has illegal items in the value of $%1 stored.",[_value] call life_fnc_numberText]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	life_atmcash = life_atmcash + _value;
	_vehicle setVariable["Trunk",[],true];
}
	else
{
	hint "Anything illegal in the vehicle.";
};