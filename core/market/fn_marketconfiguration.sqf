...
life_market_resources = [
	...
	//Schema: SHORTNAME, DEFAULT-VALUE, MIN-VALUE, MAX-VALUE, CHANGE IN ACTION [SALES multiplied by 1, Purchase multiplied to -1
