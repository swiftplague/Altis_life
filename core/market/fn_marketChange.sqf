...
switch(true) do
{
	...
	{
		[[0,"News: Interpol has dismantled an international drug gang!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: investors lose faith in gold!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: precious metals required electronics industry"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Investors lose confidence in the dollar!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: new synthetic drug flooded drug market!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: China discovered the turtles as new medicine! Animal rights activists are concerned!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
