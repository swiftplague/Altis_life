...
if( ((gunner _veh) != player) && ((driver _veh) != player)) exitWith {hint "just a shooter or a pilot can do!!";}; 
...
if(!_hasweapon) exitWith { hint "You have not the required weapon!"; _veh setVariable["bird_down_inuse", false];};
...
hint parseText format["<img size='2' image='icons\schiessplatz.paa'/>weapon system aims at % 1", typeOf _target];
...
{	
	...
	hintSilent parseText format["<img size='2' image='icons\schiessplatz.paa'/>Target<br/>%1<br/><br/>Crew<br/>%3<br/>Distance<br/><t size='1.2'>%2m / %4m</t><br/><br/>Difference in altitude<br/><t size='1.2'>%5m</t>", 
	typeOf _target, 
...
if(!_target_locked) exitWith { hint parseText "<img size='2' image='icons\schiessplatz.paa'/>Target abort!"; _veh setVariable["bird_down_inuse", false];};


 ////////////////////////////////////////////////////////////
 //PHASE 3: Actual Shoot 
  hint parseText "<img size='2' image='icons\schiessplatz.paa'/>Target process completed!";
 [player,"target_shoot"] call life_fnc_globalSound;
 playSound "target_shoot";
 sleep 1;
 hint parseText "<img size='2' image='icons\schiessplatz.paa'/>Gun being fired!";
