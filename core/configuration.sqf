...
[
	...
	["license_civ_cherrywine","civ"],
	["license_civ_grapewine","civ"],
...
//[shortVar,reward]
life_illegal_items = [["heroinu",1000],["heroinp",6500],["cocaine",3000],["cocainep",3500],["marijuana",2000],["turtle",10000],["cannabis",2000],["illegalmoney",1],["froglsd",3000],["hops",1500],["moonshine",3000],["methu",4500],["methp",6500]];
life_illegal_item_shortnames = ["heroinu","heroinp","cocaine","cocainep","marijuana","turtle","cannabis","illegalmoney","froglsd","hops","moonshine","methu","methp"];
//Items, which are deleted on the parking of the vehicle
life_illegal_item_cleared = ["heroinu","heroinp","cocaine","cocainep","marijuana","turtle","cannabis","illegalmoney","froglsd","hops","moonshine","methu","methp"]; 
life_illegal_item_buyedByIllegalMoney = ["heroinu","heroinp","cocaine","cocainep","marijuana","turtle","cannabis","illegalmoney","froglsd","hops","moonshine","methu","methp"]; //These items can only be buyed by illegal money
