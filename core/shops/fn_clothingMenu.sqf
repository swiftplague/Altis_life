...
//Cop / Civ Pre Check
if((_this select 3) in [/*"bruce","dive",*/"reb"] && playerSide == west) exitWith {hint "You have civilian use this place"; closeDialog 0;};
if((_this select 3) == "reb" && !license_civ_rebel) exitWith {hint "You still no rebel training!"; closeDialog 0;};
if((_this select 3) in ["cop"] && playerSide == civilian) exitWith {hint "You must be a policeman to use this store!"; closeDialog 0;};
