...
if(count _nearVehicles == 0) exitWith {titleText["there are no vehicles for sale in the vicinity.","PLAIN"];};
if(!(createDialog "Chop_Shop")) exitWith {hint "there was a problem with the menus open the chop shop."};
