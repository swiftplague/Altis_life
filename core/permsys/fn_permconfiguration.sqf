...
/*
	...
	The Killing Streets Altis Life Permission System (perm)
...
life_perms = [
	...
	["Not a Member","Recruit Training","Officer","Corporal","Sergeant","Lieutenant","Captain","Major","Colonel","Chief"]], 
	...
	[], "images\ADAC_256.paa",
	["Not a Member","ADAC-Recruit Training", "ADAC-Staff", "ADAC-Chef"]],
	
	//EVENTS
	["event","The Killing Streets Events", 3,[ 
		[2, ["VIEW"]],
		[3, ["LEADER", "RANKUP", "RANKDOWN", "VIEW"]]
	],  
	[], "images\Black_lagoon_Flame_256.paa",
	["Not a Member","Member", "Helper", "Head"]]
