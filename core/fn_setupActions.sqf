...
switch (playerSide) do
{
	...
	{
		//Drop fishing net
		life_actions = [player addAction["Fishing net cast",life_fnc_dropFishingNet,"",0,false,false,"",'
...
//##61 Cop license show
life_actions = life_actions + [player addAction["<t color='#00FF00'>Brand show police</t>",life_fnc_copShowLicense,"",1,false,true,"",' playerSide == west && !isNull cursorTarget && cursorTarget isKindOf "Man" ']];

//##106
//BD MK1
life_actions = life_actions + [player addAction["<t color='#FF0000'>BD-MKI 'Fuel Killer' fire</t>",life_fnc_fireBirdDown,"BDMK1",1,false,true,"",'(!(isNull (vehicle player))) && (vehicle player) isKindOf "Air" ']];
//BD MK2
life_actions = life_actions + [player addAction["<t color='#FF0000'>BD-MKII 'Electrostatic' fire</t>",life_fnc_fireBirdDown,"BDMK2",1,false,true,"",'(!(isNull (vehicle player))) && (vehicle player) isKindOf "Air" ']];
