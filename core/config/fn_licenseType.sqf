...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "winec": {_var = "license_civ_cherrywine"};
			case "wineg": {_var = "license_civ_grapewine"};
			case "beer": {_var = "license_civ_beer"};
			case "methp": {_var = "license_civ_meth"};
			//Home License ##7
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_cherrywine": {_var = "winec"};
			case "license_civ_grapewine": {_var = "wineg"};
			case "license_civ_beer": {_var = "beer"};
			case "license_civ_meth": {_var = "methp"};
