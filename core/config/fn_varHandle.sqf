...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "wineg": {"life_inv_wineg"};
			case "cherries": {"life_inv_cherries"};
			case "winec": {"life_inv_winec"};
			case "barley": {"life_inv_barley"};
			case "beer": {"life_inv_beer"};
			case "methu": {"life_inv_methu"};
			case "methp": {"life_inv_methp"};
			case "cokec": {"life_inv_cokec"};
			case "heroinc": {"life_inv_heroinc"};
			case "marijuanac": {"life_inv_marijuanac"};
			case "froglsdc": {"life_inv_froglsdc"};	//LSD
			case "moonshinec": {"life_inv_moonshinec"};
			case "methc": {"life_inv_methc"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_wineg": {"wineg"};
			case "life_inv_cherries": {"cherries"};
			case "life_inv_winec": {"winec"};
			case "life_inv_barley": {"barley"};
			case "life_inv_beer": {"beer"};
			case "life_inv_methu": {"methu"};
			case "life_inv_methp": {"methp"};
			case "life_inv_cokec": {"cokec"};
			case "life_inv_heroinc": {"heroinc"};
			case "life_inv_marijuanac": {"marijuanac"};
			case "life_inv_froglsdc": {"froglsdc"};	//LSD
			case "life_inv_moonshinec": {"moonshinec"};
			case "life_inv_methc": {"methc"};
