...
switch (_type) do
{
	...
	case "copper": {8000};
	case "cement": {6000};
	case "moonshine": {30000};
	case "winec": {2000}; //Cherry Wine processing license cost
	case "wineg": {2000}; //Grape Wine processing license cost
	case "beer": {2500}; //Grape Wine processing license cost
	case "methp": {60000};
	//Home license
	case "home": {500000}; //##7
