...
switch(_shop) do
{
			...
			default
			{
				["Altis Cop Shop",
					[
						...
						["30Rnd_556x45_Stanag_Tracer_Red","SDAR Rubber bullet 556x45",180],
						["30Rnd_556x45_Stanag","SDAR Magazine 556x45",250],
						["hgun_P07_snds_F","Taser Gun",5000],
						["16Rnd_9x21_Mag","Taser Magazine 9x21",50], 						
						["hgun_P07_F",nil,2500],
	...
	case "cop_patrol":
	{
		...
		{
			case (playerSide != west): {"You're not a COP!"};
			case (__GETC__(life_coplevel) < 3): {"You're not the Proper rank!"};
			default
			{
				["Altis Patrol Officer Shop",
					[
						//SDAR with UW ammo
						["arifle_sdar_F","SDAR",10000],
						["30Rnd_556x45_Stanag","SDAR Magazine 556x45",250], //SDAR scharfe Muni
						["20Rnd_556x45_UW_mag","Underwater SDAR Magazine 556x45",200],
						["arifle_MXC_Black_F",nil,10000],
						["muzzle_snds_H",nil,2500],
						["30Rnd_65x39_caseless_mag",nil,500],
						["30Rnd_65x39_caseless_mag_Tracer","65x39 Rubber bullet",500],
						["SMG_02_F",nil,7500],
						...
						["30Rnd_45ACP_Mag_SMG_01_tracer_green",".45 Rubber bullet",250],
	...
	case "cop_sergeant":
	{
		...
		{
			case (playerSide != west): {"You're not a COP!"};
			case (__GETC__(life_coplevel) < 5): {"You're not the Proper rank!"};
			default
			{
				["Altis Sergeant Officer Shop",
					[
						...
						["100Rnd_65x39_caseless_mag_Tracer","65x39 Rubber bullet",2000],
	...
	case "cop_sniper":
	{
		...
		{
			case (playerSide != west): {"You're not a COP!"};
			case (!license_cop_sniper): {"You're not a sniper!"};
			default
			{
				["Altis Sniper Shop",
					[
	...
	case "rebel":
	{
		switch(true) do
		{
			case (playerSide != civilian): {"You're not a COP!"};
			case (!license_civ_rebel): {"You have no rebel license!"};
			default
			{
	...
	case "donator":
	{
		switch(true) do
		{
			case (__GETC__(life_donator) == 0): {"You're not a donor!"};
			case (__GETC__(life_donator) >= 1):
			{
				["The Killing Streets Donator Shop",
					[
	...
	case "event":
	{
		if( [] call life_fnc_playerInEvent ) then
		{
			["*** Event ***",
					[						
						["hgun_P07_snds_F","Taser Gun",1],
						["16Rnd_9x21_Mag","Taser Magazine 9x21",1],
						["hgun_P07_F",nil,2500],
						["16Rnd_9x21_Mag",nil,50],
						["Binocular",nil,150],
						["Rangefinder",nil,500],
		...
		{
			hint "You're not a participant of the event!";
			[];
		};
	};
};
