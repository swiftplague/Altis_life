...
{
	hint "You do not have access to this house!";
...
{
	hint "Someone else already accesses the inventory!";
};
...
//Allg. action inuse
if(life_action_inUse) exitWith {hint "You're watching something else.";};
