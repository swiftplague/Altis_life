...
if (count _exdata == 0) exitWith { hint "Could not load house data."; };
...
{
	hint "Someone else accesses already on the House!";
};
...
//Allg. action inuse
if(life_action_inUse) exitWith {hint "You're using something else.";};
