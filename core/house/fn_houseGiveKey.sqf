...
if(_index == -1) exitWith {life_action_inUse = false; hint "Nothing selected chosen."; };
...
if(_existing) exitWith { hint "Player already has a key in the key!"; life_action_inUse = false; };
