...
if((_vehicle getVariable ["trunk_in_use",false])) exitWith {hint "The trunk of the vehicle is used by someone else at the moment."};
...
[_vehicle] spawn
{
	...
	hintSilent "Note: Things that are illegal are not saved when you park it in the garage.";
