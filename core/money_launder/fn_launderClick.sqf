...
{
	hint "You gave up too much money!";
	sleep 2;
	hint format ["You've only got $%1",  [_illegal_money] call life_fnc_numberText];
};
...
{
	hint format["You get $%1 on your account, if you wash this amount. Click again on the washing button to confirm.", [_finalmoney] call life_fnc_numberText];
